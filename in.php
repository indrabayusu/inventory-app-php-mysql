        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h2 class="mt-4 fs-3" style="padding-bottom: 15px;">Incoming Stock</h2>
                    <div class="card mb-4">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <input type="text" name="keterangan" value="<?=$keterangan;?>" placeholder="Receiver" class="form-control" required>
                                                    <br>
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post">
                            <div class="modal-body">
                                ...
                                <br>
                                <input type="text" name="penerima" class="form-control" placeholder="Receiver" required>
                                <br>
                                <button type="submit" class="btn btn-primary" name="barangmasuk">Add</button>
                            </div>
                        </form>
                    </div>
                </div>
